...
public:
  ...
  UI_TextBox(sf::Vector2i pos, std::string text,int font_size = 24, sf::Color text_col = sf::Color::White, sf::Color bg_col = sf::Color(0,0,0,100), std::string filename = "data/font.ttf");
